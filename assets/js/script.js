...
async function getAboutGithub() {
    try {
        const resposta = await fetch('https://api.github.com/users/robertairds');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                <h2>Sobre mim</h2>
                <p>
                    Atualmente curso Análise e Desenvolvimento de Sistemas e participo do Bootcamp Java Full Stack da Generation Brasil, onde desenvolvo projetos utilizando Java, Spring Boot, SQL, Git, GitHub, HTML, CSS e JavaScript.
                </p>

                <p>
                    Antes da tecnologia, trabalhabei com Recursos Humanos Generalista, experiência que fortaleceu minhas habilidades de comunicação, organização, resolução de problemas e melhoria de processos. Um exemplo foi a implementação do benefício de Day Off para colaboradores.
                </p>

                <p>
                Também vivi mais de dois anos entre Irlanda e Espanha, desenvolvendo inglês avançado, espanhol B2 e ampliando minha capacidade de adaptação em ambientes multiculturais.
                </p>

                <p>
                 Atualmente busco minha primeira oportunidade em tecnologia para aplicar meus conhecimentos, continuar aprendendo e crescer profissionalmente na área de desenvolvimento de software. 
                </p>
...
async function getProjectsGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/robertairds/repos?sort=updated&per_page=6');
